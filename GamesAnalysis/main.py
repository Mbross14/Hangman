...
plt.scatter(df_main["first_released_date"], df_main["user_rating_value"], color = "blue", label = "User Ratings")
...
df_main = pd.read_cvs("game-ratings-by-top-10-genres.csv")
...
df.hype = df_hype.rename(columns = { "hype_count": "total_hypes" })
...
df_main = pd.read_cvs("game-ratings-by-top-10-platforms.csv")
